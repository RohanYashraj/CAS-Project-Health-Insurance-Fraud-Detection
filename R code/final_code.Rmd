...
clean_data1 = readRDS("../Input_dataset/cleaned_input_data.rds")
...
trigger_data <- read_excel("../files_for_trigger_functions/trigger_table.xlsx")
...
data <- 
  read_excel("../files_for_trigger_functions/empanelled_hospitals_list_masked.xlsx") %>% 
  janitor::clean_names() %>% 
...
data <- 
  read_excel("../files_for_trigger_functions/district_distances_masked.xlsx") %>% 
